...
/* UART4：每秒发送编码器速度，或连接 JY61P IMU。 */
#define APP_UART4_MODE_ENCODER  1
#define APP_UART4_MODE_JY61P    2
/* 当前选择：APP_UART4_MODE_ENCODER / APP_UART4_MODE_JY61P。 */
#define APP_UART4_MODE          APP_UART4_MODE_JY61P
